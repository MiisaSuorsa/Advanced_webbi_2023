...
function _create() {
  _create = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var div, x, div1, h1, div2, p, text, dogText, div3, response, dogImage, img;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            div1.setAttribute("class", "wiki-item"); //h1

            h1 = document.createElement("h1");
            h1.setAttribute("class", "wiki-header");
            h1.textContent = "Breed name"; //div

            div2 = document.createElement("div");
            div2.setAttribute("class", "wiki-content"); //p

            p = document.createElement("p");
            p.setAttribute("class", "wiki-text");
            _context.next = 15;
            return fetch('https://en.wikipedia.org/api/rest_v1/page/summary/coton_de_tulear');
          ...
          case 18:
            dogText = _context.sent;
            p.innerHTML = dogText.extract; //div

            div3 = document.createElement("div");
            div3.setAttribute("class", "img-container"); //img
          ...
          case 27:
            dogImage = _context.sent;
            img = document.createElement("img");
            img.setAttribute("class", "wiki-img"); //img.setAttribute("src", imageJson.message);
